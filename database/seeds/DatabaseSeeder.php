...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('ciudades')->insert([
            ...
            ['id' => 39, 'idPais' => 1,  'Nombre' => 'Coruña, La', 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ...
            ['id' => 43, 'idPais' => 1,   'Nombre' => 'Rioja, La', 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 44, 'idPais' => 1,  'Nombre' => 'Baleares, Islas', 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ...
            ['id' => 48, 'idPais' => 1,    'Nombre' => 'Palmas, Las', 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 49, 'idPais' => 1,    'Nombre' => 'Tenerife, Santa Cruz De', 'created_at' => new DateTime, 'updated_at' => new DateTime],
